...
$status			=	1;
	...
	if($n>0)
		...
		$query	=	mysqli_query($db,"UPDATE `shop_category` SET 
																		`parent_id`		= '$parent_id',
...
$db = new mysqli(SERVER, USERNAME, PASSWORD, DATABASE);
$category_id	=	filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
$q		=	mysqli_query($db,"SELECT * FROM `shop_category` WHERE category_id=$category_id");
...
?>
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php echo get_category_lists($r['parent_id']); ?>
						</div>
					</div><!-- form-group -->
