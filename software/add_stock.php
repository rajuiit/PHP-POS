...
if(isset($_POST['parent_id'])){$ClientID=$_POST['parent_id'];}else{$ClientID="";}
if(isset($_POST['product_price'])){$ProductPrice=$_POST['product_price'];}else{$ProductPrice="";}

if(isset($_POST['sell_price'])){$SellPrice=$_POST['sell_price'];}else{$SellPrice="";}


if(isset($_POST['purchases_invoice_id'])){$PurchasesInvoiceId=$_POST['purchases_invoice_id'];}else{$PurchasesInvoiceId="";}
...
$client_id	=	filter_input(INPUT_POST, 'parent_id', FILTER_SANITIZE_SPECIAL_CHARS);
$purchases_invoice_id	=	filter_input(INPUT_POST, 'purchases_invoice_id', FILTER_SANITIZE_SPECIAL_CHARS);
...
$sell_price	=	filter_input(INPUT_POST, 'sell_price', FILTER_SANITIZE_SPECIAL_CHARS);
...
$query	=	mysqli_query($db,"INSERT INTO `shop_products_price` (
												`price_id` ,
												`product_id` ,
												`product_price` ,
												`sell_price` ,
...
//echo $request_id;
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<?php echo get_company_lists($ClientID); ?>
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" name="purchases_invoice_id" value="<?php echo $PurchasesInvoiceId; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						<input type="text" name="sell_price" value="<?php echo $SellPrice; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
