...
$balance=get_company_balance_info($company_id)
+$credit-$debit;
...
$query	=	mysqli_query($db,"INSERT INTO `shop_company_ledger` (
														`ledger_id` ,
														`company_id` ,
														`invoice_id` ,
														`add_date` ,
...
//echo $request_id;
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text"  name="customer_name" value="<?php echo get_company_info("company_name",$company_id); ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
