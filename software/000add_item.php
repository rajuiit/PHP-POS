...
//echo $request_id;
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<!--input type="test" name="product_code" value="<?php //echo $n_code; ?>" class="form-control" /-->
						<input type="test" name="product_code" value="<?php echo $ProductCode; ?>" class="form-control" />
