...
$sql = "SELECT customer_name,invoice_id,amount,customer_id,add_date";
$sql.=" FROM shop_invoice";
$query=mysqli_query($conn, $sql) or die("invoice_processing.php: get employees");
...
if( !empty($requestData['search']['value']) ) {
	...
	$query=mysqli_query($conn, $sql) or die("invoice_processing.php: get employees"); // again run query with limit
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<div align='center'><a href='invoice.php?id=".$row["invoice_id"]."' title='Print' target='blank' class='btn btn-success'><span class='glyphicon glyphicon-print'></span></a>
