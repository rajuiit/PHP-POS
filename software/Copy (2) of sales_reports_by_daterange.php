  ...
  border-spacing: 0;
		...
		$q	=	mysqli_query($db,"SELECT * FROM `shop_cash_sales` WHERE (add_date BETWEEN '$date1' AND '$date2') ORDER BY add_date ASC");
					...
					?>
						...
						<td><div align="center"><?php echo $r['net_amount']; ?></div></td>
						<td><div align="center"><?php echo $r['quantity']; ?></div></td>
						<td><div align="center">
						<?php

						$total_cash_taka	=	$r['net_amount']*$r['quantity'];
...
$db 	= 	new mysqli(SERVER, USERNAME, PASSWORD, DATABASE);
$q_dis	=	mysqli_query($db,"SELECT sum(`discount`) AS TOTAL FROM `shop_invoice` WHERE (add_date BETWEEN '$date1' AND '$date2') AND showroom_id=$showroom_id");
