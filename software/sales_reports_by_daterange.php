...
$company_id=filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Sales Report </title>');
            ...
            frameDoc.document.write('<h1 style=text-align:center;margin-top:0;margin-bottom:0;>Sales Report </h1>');
...
table {
  ...
  border-spacing: 0;
				...
				<table id="basicTable" width="1100" border="1" cellpadding="5" cellspacing="0" class="table table-striped table-bordered responsive">
					...
					<thead class="">
						<tr>
							<th>SL</th>
							<th>Item Name</th>                                      
							<th><div align="center">MRP</div></th>            
							<th><div align="center">Qty</div></th> 
							<th><div align="center">Net Total</div></th> 
						</tr>
					</thead>
		...
		//$q	=	mysqli_query($db,"SELECT * FROM `shop_cash_sales` WHERE (add_date BETWEEN '$date1' AND '$date2') AND showroom_id=$showroom_id ORDER BY add_date ASC");
		$q	=	mysqli_query($db,"SELECT * FROM `shop_cash_sales` WHERE (add_date BETWEEN '$date1' AND '$date2') ORDER BY add_date ASC");
					...
					?>
						...
						//$total_cash_taka	=	$r['invoice_amount']*$r['quantity'];
						$total_cash_taka	=	$r['invoice_amount'];
...
<tr>
	<td colspan="4"><div align="right">Total Invoice Amount=</div></td>
	<td><div align="center"><?php echo number_format($total_cash,2); ?> Taka</div></td>
</tr>
...
$db 	= 	new mysqli(SERVER, USERNAME, PASSWORD, DATABASE);
//$q_dis	=	mysqli_query($db,"SELECT sum(`discount`) AS TOTAL FROM `shop_cash_sales` WHERE (add_date BETWEEN '$date1' AND '$date2') AND showroom_id=$showroom_id");
$q_dis	=	mysqli_query($db,"SELECT sum(`discount`) AS TOTAL FROM `shop_invoice` WHERE (add_date BETWEEN '$date1' AND '$date2')");
$r_dis	=	mysqli_fetch_array($q_dis);
?>
							
<tr>
	<td colspan="4"><div align="right">Total Discount=</div></td>
	<td><div align="center"><?php echo number_format($r_dis['TOTAL'],2); ?> Taka</div></td>
</tr>
					
					
<tr>
	<td colspan="4"><div align="right">Net Total=</div></td>
	<td><div align="center"><?php echo number_format(($total_cash-$r_dis['TOTAL']),2); ?> Taka</div></td>
</tr>
