...
//$query	=	mysqli_query($db,"SELECT * FROM `shop_product`");
$query	=	mysqli_query($db,"SELECT * FROM `shop_product` ORDER BY `product_id` DESC limit 0,1");
$rrr	=	mysqli_fetch_array($query);
$n_code	= $rrr['product_code']+1;
...
//if(isset($_POST['product_code'])){$ProductCode=$_POST['product_code'];}else{$ProductCode=$n_code;}
...
//echo $request_id;
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="hidden" name="product_code" value="<?php echo $n_code; ?>" class="form-control" />
						<input type="text" name="product_code" value="<?php echo $n_code; ?>" class="form-control" Disabled />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="text" name="product_details" value="<?php echo $ProductDetails; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
