...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Ledger of <?php echo get_credit_customer_info("customer_name",$customer_id); ?></title>');
            frameDoc.document.write('</head><body>');
            frameDoc.document.write('<h1 style=text-align:center;>Ledger of <?php echo get_credit_customer_info("customer_name",$customer_id); ?></h1>');
        ...
        <section>
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <h4> Ledger of <?php echo get_credit_customer_info("customer_name",$customer_id); ?> </h4>
...
function get_marketing_client_info($info,$client_id)
	{
	$db = new mysqli(SERVER, USERNAME, PASSWORD, DATABASE);
	$q	=	mysqli_query($db,"SELECT $info FROM tc_marketing_client WHERE id=$client_id");
...
$customer_id=filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		$q	=	mysqli_query($db,"SELECT * FROM `shop_credit_customer_ledger` WHERE customer_id=$customer_id AND (add_date BETWEEN '$date1' AND '$date2') ORDER BY add_date ASC");
	...
	<tr>
		...
		echo number_format($r['debit'],2); $total_due=$total_due+$r['debit'];
		?>
		</div></td>
		<td><div align="center">
		<?php 
		echo number_format($r['credit'],2); $total_payment=$total_payment+$r['credit'];
		?></div></td>
		<td><div align="center">
		
		<?php 
		echo number_format($r['balance'],2); $total_balance=$total_balance+$r['balance'];
		?>
					...
					?>								
						...
						<tr>
						<td colspan="3"><div align="right"><b>Sub Total</b></div></td>
						<td><div align="center"><b><?php echo number_format($total_due,2); ?> Taka</b></div></td>
						<td><div align="center"><b><?php echo number_format($total_payment,2); ?> Taka</b></div></td>
						<td><div align="center"><b><?php echo number_format(($total_due-$total_payment),2); ?> Taka</b></div></td>
						</tr>
