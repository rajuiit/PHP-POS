...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Ledger of <?php echo get_company_info("company_name",$company_id); ?></title>');
            frameDoc.document.write('</head><body>');
            frameDoc.document.write('<h1 style=text-align:center;>Ledger of <?php echo get_company_info("company_name",$company_id); ?></h1>');
        ...
        <section>
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <h4> Ledger of <?php echo get_company_info("company_name",$company_id); ?> </h4>
				...
				<table id="basicTable" width="1100" border="1" cellpadding="5" cellspacing="0" class="table table-striped table-bordered responsive">
					...
					<thead class="">
						<tr>
							...
							<th><div align="center">Invoice ID</div></th>
...
$company_id=filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		$q	=	mysqli_query($db,"SELECT * FROM `shop_company_ledger` WHERE company_id=$company_id AND (add_date BETWEEN '$date1' AND '$date2') ORDER BY add_date ASC");
	...
	<tr>
		...
		<td><div align="center"><?php echo $r['invoice_id']; ?></div></td>
		...
		?>
					...
					?>								
						...
						<tr>
						<td colspan="4"><div align="right"><b>Sub Total</b></div></td>
