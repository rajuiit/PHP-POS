...
$status						=	1;
	...
	//Display error msg
		...
		if($user_password=='')
			{ $err[]="Please select user password";}
	...
	if($n>0)
      ...
      <div class="alert alert-warning">
		...
		$query	=	mysqli_query($db,"INSERT INTO `shop_users` (`user_id`, 
																	`showroom_id`, 
																	`user_name`, 
																	`user_address`, 
																	`telephone`, 
						...
						<div class="col-sm-8">
							<?php echo get_shop_showroom_lists($ShowroomID); ?>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text"  name="user_name" value="<?php echo $UserName; ?>" class="form-control" />
                                                </div>
                                            </div><!-- form-group -->
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea name="user_address"  class="form-control"><?php echo $UserAddress; ?></textarea>
                                                </div>
                                            </div><!-- form-group -->
											...
											<div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text"  name="login_name" value="<?php echo $LoginName; ?>" class="form-control" />
                                                </div>
                                            </div><!-- form-group -->
