...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Stock In Report</title>');
            frameDoc.document.write('</head><body>');
            frameDoc.document.write('<h1 style=text-align:center;>Stock In Report</h1>');
            ...
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <h4> Stock In Report </h4>
					...
					<a style="float: right;
margin-top: -31px;" class="btn btn-success" href="stock_list.php">Stock In Report</a>
