...
");
	...
	$query7	=	mysqli_query($db,"UPDATE `shop_product` SET
...
<a href="cash_invoice_print.php?invoice_id=<?php echo $invoice_id; ?>" target="_blank"><center><h3>POS Print</h3></center></a>

<a href="invoice.php?id=<?php echo $invoice_id; ?>" target="_blank"><center><h3>Normal Print</h3></center></a>
...
$product_n	= 	get_product_info("product_name",$_POST['product_name']);		
$product_c	= 	get_product_info("product_code",$_POST['product_name']);	

$product_name	= 	$product_n."_".	$product_c;
