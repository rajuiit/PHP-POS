...
{
$debit_id	=	filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
...
$add_date			=	date('Y-m-d');
	...
	if($n>0)
		...
		$query	=	mysqli_query($db,"UPDATE `shop_debits` SET 
...
$db = new mysqli(SERVER, USERNAME, PASSWORD, DATABASE);
$debit_id	=	filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
$q		=	mysqli_query($db,"SELECT * FROM `shop_debits` WHERE debit_id=$debit_id");
...
?>                           
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php get_expense_category_lists($r['category_id']); ?>
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="text" name="invoice_id" value="<?php echo $r['invoice_id']; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="text" name="remarks" value="<?php echo $r['remarks']; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
