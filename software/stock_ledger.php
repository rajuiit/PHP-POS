...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Ledger of <?php echo get_product_info("product_name",$product_id); ?></title>');
            frameDoc.document.write('</head><body>');
            frameDoc.document.write('<h1 style=text-align:center;>Ledger of <?php echo get_product_info("product_name",$product_id); ?></h1>');
        ...
        <section>
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <h4> Ledger of <?php echo get_product_info("product_name",$product_id); ?> </h4>
					
					<a style="float: right;
margin-top: -31px;" class="btn btn-success" href="stock_list.php">Stock List</a>
				...
				<table id="basicTable" width="1100" border="1" cellpadding="5" cellspacing="0" class="table table-striped table-bordered responsive">
					...
					<thead class="">
						<tr>
							...
							<th><div align="center">Stock IN</div></th>
							<th><div align="center">Stock Return</div></th>
							<th><div align="center">Sales</div></th> 
							<th><div align="center">Current Stock</div></th> 
						</tr>
					</thead>
...
$product_id=filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		$q	=	mysqli_query($db,"SELECT * FROM `shop_stock` WHERE product_id=$product_id AND (add_date BETWEEN '$date1' AND '$date2') ORDER BY add_date ASC");
	...
	<tr>
		...
		<td><div align="center"><?php echo $r['stock_in']; ?></div></td>
		<td><div align="center"><?php echo $r['stock_out']; ?></div></td>
		<td><div align="center"><?php echo $r['sales']; ?></div></td>
		<td><div align="center"><?php echo $r['current_stock']; ?></div></td>
