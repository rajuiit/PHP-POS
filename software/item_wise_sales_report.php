...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Item Wise Sales Report</title>');
            ...
            frameDoc.document.write('<h1 style=text-align:center;margin-top:0;margin-bottom:0;>Item Wise Sales Report</h1>');
				...
				<table id="basicTable" width="1100" border="1" cellpadding="5" cellspacing="0" class="table table-striped table-bordered responsive">
					...
					<thead class="">
						<tr>
							...
							<th><div align="center">Sales Quantity</div></th>
...
$product_id=filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		$q	=	mysqli_query($db,"SELECT * FROM `shop_cash_sales` WHERE product_id=$product_id AND (add_date BETWEEN '$date1' AND '$date2') GROUP BY add_date ORDER BY add_date ASC");
	...
	<tr>
		...
		<td><div align="center"><?php echo get_item_wise_sales_product_quantity($r['add_date']); ?></div></td>
		<td><div align="center"><?php 
		$price	=	get_item_wise_sales_product_amount($r['add_date']);
