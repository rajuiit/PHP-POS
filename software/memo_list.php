                    ...
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <a href="memo_list.php" class="btn btn-success" style="float: right;
margin-top: -31px;">Memo List</a>
...
$status				=	1;
	...
	if($n>0)
		...
		$query	=	mysqli_query($db,"INSERT INTO `shop_expense_category` (
															`category_id` ,
															`parent_id` ,
															`category_name` ,
															`category_slug` ,
...
//echo $request_id;
		    ...
		    <div class="row">
						 ...
						 <div class="col-md-12">
								...
								<form class="form-horizontal" action="memo_invoice.php?" method="GET" target="blank">
					...
					<div class="form-group">
						<label class="col-sm-5 control-label">Memo ID:</label>
						<div class="col-sm-8">
						<input type="text" name="memo_id" value="<?php echo $CategoryName; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="panel-footer">
						<div id="submit_button">
							<button name="action22" value="SAVE" class="btn btn-primary mr5">Submit</button>
