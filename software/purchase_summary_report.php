...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Sales Summary Report</title>');
            ...
            frameDoc.document.write('<h1 style=text-align:center;margin-top:0;margin-bottom:0;>Sales Summary Report</h1>');
...
$q	=	mysqli_query($db,"SELECT * FROM `shop_stock` WHERE status=1 AND stock_in!=0 AND (add_date BETWEEN '$date1' AND '$date2') GROUP BY product_id ORDER BY add_date ASC");
...
?>
	...
	<tr>
		...
		<td><div align="center"><?php echo $r['stock_in']; ?><?php //echo get_sales_summary_product_id($r['product_id']); ?></div></td>
		<td><div align="center"><?php 
		//$price	=	get_sales_summary_product_price($r['product_id']);
		
		$price			=	get_product_info("purchases_price",$r['product_id']);
		$price_quantity	=	$r['stock_in'];
		$total_price	=	$price*$price_quantity;
		
		echo number_format($total_price,2); $total_cash=$total_cash+$total_price;
	...
	<tr>
	<td colspan="5"><div align="right"> <b>Net Total =</b></div></td>
	<td><div align="center"> <b><?php echo  number_format($total_cash,2); ?> Taka</b></div></td>
