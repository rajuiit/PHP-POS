...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title><?php echo get_expense_category_info("category_name",$category_id); ?> Wise Sales Report</title>');
            frameDoc.document.write('</head><body>');
            frameDoc.document.write('<h1 style=text-align:center;><?php echo get_expense_category_info("category_name",$category_id); ?> Wise Sales Report</h1>');
        ...
        <section>
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <h4><?php echo get_expense_category_info("category_name",$category_id); ?> Wise Sales Report</h4>
...
$category_id=filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
		...
		$q	=	mysqli_query($db,"SELECT * FROM `shop_debits` WHERE category_id=$category_id AND (add_date BETWEEN '$date1' AND '$date2') ORDER BY add_date ASC");
	...
	<tr>
		...
		<td><?php echo get_expense_category_info("category_name",$r['category_id']); ?></td>
	...
	<tr>
	<td colspan="3"><div align="right"> <b>Net Total =</b></div></td>
