            ...
            <div class="mainwrapper">
			   ...
			   <?php include("left_menu.php"); ?>
                ...
                <div class="mainpanel">
				   ...
				   <a href="expense_category_list.php" class="btn btn-success" style="float: right;
margin-top: -31px;">Expense Category List</a>
...
$status				=	1;
	...
	if (!isset($_POST["status"])) { $status=0; }
		...
		$query	=	mysqli_query($db,"UPDATE `shop_expense_category` SET 
																`parent_id`		= '$parent_id',
...
$db = new mysqli(SERVER, USERNAME, PASSWORD, DATABASE);
$category_id	=	filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);
$q		=	mysqli_query($db,"SELECT * FROM `shop_expense_category` WHERE category_id=$category_id");
...
?>
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php echo get_expense_category_lists($r['parent_id']); ?>
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="text" name="category_name" value="<?php echo $r['category_name']; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
