...
<table id="basicTable" width="600" class="table table-striped table-bordered responsive">
<thead class="">
	<tr>
		<th width="120">SL No.</th>
		<th>Item Name</th>                   
		<th width="220"><div align="center">Quantity</div></th>
	</tr>
</thead>
...
?>
	<tr>
		<td><input type="checkbox" name='checkbox[]' id='checkbox[]' /> <?php echo $x; ?></td>
		<td><input type="text" size="8" name="item_name[]"></td>
		<td><input type="text" size="8" name="item_amount[]"></td>
	</tr>
<?php
}
?>	
