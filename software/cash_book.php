...
<script type="text/javascript">
        function PrintDiv() {
            ...
            frameDoc.document.write('<html><head><title>Cash Book Report</title>');
            ...
            frameDoc.document.write('<h1 style=text-align:center;margin-top:0;margin-bottom:0;>Cash Book Report</h1>');
				...
				<table id="basicTable" width="1100" border="1" cellpadding="5" cellspacing="0" class="table table-striped table-bordered responsive">
					...
					<thead class="">
						<tr>
							...
							<th><div align="center">Total Price</div></th>
						</tr>
...
$q	=	mysqli_query($db,"SELECT sum(`net_amount`) AS OPENING_BALANCE FROM `shop_cash_sales` WHERE ( `add_date`<'$date1')");

$r 	=	mysqli_fetch_array($q);

$qq	=	mysqli_query($db,"SELECT sum(`amount`) AS OPENING_EXPENSE FROM `shop_debits` WHERE ( `add_date`<'$date1')");
$rr 	=	mysqli_fetch_array($qq);

$opening_balance	=	$r['OPENING_BALANCE'];
$opening_expense	=	$rr['OPENING_EXPENSE'];

$net_opening_balance	=	$opening_balance-$opening_expense;
					
?>

<tr>							
	<th colspan="2"><div align="right">Opening Balance</div></th>
	<th><div align="center"><?php echo number_format($net_opening_balance,2); $total_opening_cash=$total_opening_cash+$net_opening_balance; ?></div></th>
</tr>
...
<?php		
		...
		$q	=	mysqli_query($db,"SELECT sum(net_amount) AS NET_AMOUNT,add_date FROM `shop_cash_sales` WHERE (add_date BETWEEN '$date1' AND '$date2') GROUP BY add_date ORDER BY add_date ASC");
					while($r	=	mysqli_fetch_array($q))
					{
					?>
					
	<tr>
		<td><div align="center"><?php echo $sl; $sl+=1; ?></div></td>
		
		<td><div align="center"><?php echo $r['add_date']; ?></div></td>

		<td><div align="center"><?php 
		$price	=	$r['NET_AMOUNT'];
		echo number_format($price,2); $total_cash=$total_cash+$price;
	...
	<tr>
	<td colspan="2"><div align="right"> <b>Total Cash=</b></div></td>
	<td><div align="center"> <b><?php echo  number_format(($total_cash+$total_opening_cash),2); ?> Taka</b></div></td>
	
	</tr>
		
<?php		
		$q2	=	mysqli_query($db,"SELECT sum(amount) AS NET_AMOUNT2,add_date FROM `shop_debits` WHERE (add_date BETWEEN '$date1' AND '$date2') GROUP BY add_date ORDER BY add_date ASC");
	...
	<tr>
		...
		<td><div align="center"><?php echo $r2['add_date']; ?></div></td>

		<td><div align="center"><?php 
		$price2	=	$r2['NET_AMOUNT2'];
		echo number_format($price2,2); $total_expemse=$total_expemse+$price2;
	...
	<td colspan="2"><div align="right"> <b>Total Expense=</b></div></td>
	<td><div align="center"> <b><?php echo  number_format(($total_expemse),2); ?> Taka</b></div></td>
	
	</tr>

	<tr>							
	<th colspan="2"><div align="right">Cash-In-Hand=</div></th>
	<th><div align="center"><?php echo  number_format((($total_cash+$total_opening_cash)-$total_expemse),2); ?> Taka</div></th>
</tr>
