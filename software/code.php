 ...
 */
	...
	imagejpeg($image, 'barcode.jpg');
	imagepng($image);
	imagedestroy($image);
	
	//echo $_GET['text'];
	$code	=	filter_input(INPUT_GET, 'text', FILTER_SANITIZE_SPECIAL_CHARS);

	echo ("<META HTTP-EQUIV=Refresh CONTENT=\"1; URL=print.php?code=$code\">");
