...
if(isset($_POST['referance_name'])){$ReferanceName=$_POST['referance_name'];}else{$ReferanceName="";}
if(isset($_POST['referance_mobile'])){$ReferanceMobile=$_POST['referance_mobile'];}else{$ReferanceMobile="";}
...
$query	=	mysqli_query($db,"INSERT INTO `shop_credit_customer` (
			`customer_id` ,
			`customer_name` ,
			`customer_code` ,
			`customer_address` ,
...
//echo $request_id;
		    ...
		    <div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text"  name="customer_name" value="<?php echo $CustomerName; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text"  name="customer_code" value="<?php echo $CustomerCode; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="customer_phone" value="<?php echo $CustomerPhone; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea name="customer_address" id="wysiwyg" rows="3" class="form-control"><?php echo $CustomerAddress; ?></textarea>
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text"  name="referance_name" value="<?php echo $ReferanceName; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text"  name="referance_mobile" value="<?php echo $ReferanceMobile; ?>" class="form-control" />
						</div>
					</div><!-- form-group -->
